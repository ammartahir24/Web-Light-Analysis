...
class MyHTMLParser(HTMLParser):
    ...
    def handle_data(self, data):
        ...
        datadict.append((copy.deepcopy(stack),data))
...
csv_reader = ['wikipedia.org','zillow.com','yahoo.com']
for web in csv_reader:
    ...
    if os.path.exists(web):
        ...
        try:
        	parser.feed(content)
        	data = datadict
        	with open(web+"/mobile/mini/parsed2.json", 'w') as outfile:
        ...
        try:
        	...
        	data = datadict
        	with open(web+"/mobile/main/parsed2.json", 'w') as outfile:
				json.dump(data, outfile)
        	datadict =[]
        except Exception as e:
        	print (e)
